# 📋 Daftar Isi - Panduan Belajar HTML untuk Siswa SMA
...
### 5.8 Input Datetime Local di HTML
...
### 6.5 Atribut Value di Input HTML
- `value` attribute
- Default values
- Dynamic values
- Data persistence
...
### 7.4 Perbedaan Elemen Block dan Inline
